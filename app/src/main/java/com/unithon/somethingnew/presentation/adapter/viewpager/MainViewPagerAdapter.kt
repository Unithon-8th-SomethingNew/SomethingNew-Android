...
import com.unithon.somethingnew.presentation.friends.friendListActivity
...
class MainViewPagerAdapter(activity: FragmentActivity): FragmentStateAdapter(activity) {
    ...
    private val fragmentList = listOf<Fragment>(MapFragment(), friendListActivity(), SettingsFragment())
